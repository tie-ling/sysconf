    ...
    accounts = {
      "gmail" = {
        ...
        imapnotify = {
          ...
          boxes = [ "INBOX" ];
          onNotifyPost =
      "${config.services.emacs.package}/bin/emacsclient --eval '(progn (mu4e t) (mu4e-update-mail-and-index nil))'";
        ...
        msmtp.enable = true;
        passwordCommand = "${pkgs.coreutils-full}/bin/cat /old/home/yc/email-password.txt";
        realName = "Yuchen Guo";
      };
    };
  };
